...
class TotalAdapter  (private val listener: (Int, Distributions) -> Unit) : RecyclerView.Adapter<TotalAdapter.CommentHolder>() {
    ...
    class CommentHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun init(parent: ViewGroup, viewType: Int) : TotalAdapter.CommentHolder {
                val view = parent.inflate(R.layout.item_distribution)
                return TotalAdapter.CommentHolder(view)
            }
        }
    }
}